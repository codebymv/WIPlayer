...
document.addEventListener('DOMContentLoaded', () => {
    ...
    updateVisualizerColors('background-scheme-1'); // Set a default scheme
...
function setMusic(i) {
    ...
    updateVisualizerColors(songs[i].colorScheme); // Set visualizer colors based on the song's color scheme
}
